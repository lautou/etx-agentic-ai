...
def run_agent(pod_name, namespace):
    ...
    #     '{"owner":"lautou","repo":"etx-agentic-ai",'
    ...
    try:
        ...
        fallback_prompt = (
            ...
            "Then create a Github issue with owner 'lautou', repo 'etx-agentic-ai', "
